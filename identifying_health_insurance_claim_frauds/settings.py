...
ROOT_URLCONF = 'identifying_health_insurance_claim_frauds.urls'
...
WSGI_APPLICATION = 'identifying_health_insurance_claim_frauds.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'identifying_health_insurance_claim_frauds',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
